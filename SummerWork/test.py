...
workbook = xlsxwriter.Workbook('TEST_OUTPUT.xlsx') #Creating new workbook to write into
...
#worksheet1.write('AB2', "Interdisciplinary instruction",bold)
...
row = 2   # Shortcut way to print all the content data in a row
col = 0
